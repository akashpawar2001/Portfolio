...
import AdminPanelMain from "../../assets/AdminPanel.png";
import AdminPanel2 from "../../assets/AdminPanel2.png";
import AdminPanel3 from "../../assets/AdminPanel3.png";
import AdminPanel4 from "../../assets/AdminPanel4.png";
import AdminPanel5 from "../../assets/AdminPanel5.png";
  ...
  return (
    <>
      <section className="py-10">
        ...
        >
          <h1 className="lg:text-5xl md:text-3xl tracking-wide font-bold inline">
            ...
            />
            <span>Admin Panel - For Artstudio Project.</span>
            <img
              src="https://wpriverthemes.com/landing/gridx-html/assets/images/star-2-2.png"
        ...
        >
          <img src={AdminPanelMain} className="object-contain" />
          <div className="absolute w-full h-full bg-black/45 flex justify-center items-center -translate-x-full group-hover:translate-x-0">
            <div className="z-10 gap-12 flex w-full h-full items-center justify-center backdrop-blur-sm p-10 rounded-3xl">
              <a
                href="https://github.com/akashpawar2001/AdminPanel/tree/master/AdminPanel"
                target="_blank"
      ...
      <section ref={ref} className="py-5 bg-transparent">
        ...
        >
          ...
          <div className="lg:col-span-6 col-span-full overflow-hidden flex flex-col items-start px-10 py-8 rounded-2xl bg-slate-50">
            <div className="flex flex-col items-start gap-5">
              <h1 className="font-semibold">Dashboard Features</h1>
              <h2 className="text-gray-500">
                The admin panel provides a comprehensive dashboard with the
                following features:
              </h2>
              <div className="flex flex-col gap-1">
                <ol className="flex flex-col gap-2 text-gray-400">
                  <li>
                    <span className="font-semibold text-blue-500">
                      1. View Latest Orders :{" "}
                    </span>{" "}
                    Admins can see the most recent orders placed by users.
                  </li>
                  <li>
                    <span className="font-semibold text-blue-500">
                      2. View Latest Customers :{" "}
                    </span>{" "}
                    Admins can see the newest registered customers.
                  </li>
                  <li>
                    <span className="font-semibold text-blue-500">
                      3. Total Service Income :{" "}
                    </span>{" "}
                    Admins can view the total income generated from services.
                  </li>
                  <li>
                    <span className="font-semibold text-blue-500">
                      4. View Feedback :{" "}
                    </span>{" "}
                    Admins can read feedback from users.
                  </li>
                  <li>
                    <span className="font-semibold text-blue-500">
                      5. Download Images :{" "}
                    </span>{" "}
                    Admins can download images uploaded by users.
                  </li>
                  <li>
                    <span className="font-semibold text-blue-500">
                      6. Upload Portraits/Drawings :{" "}
                    </span>{" "}
                    Admins can upload new portraits or drawings for users to
                    view.
                  </li>
                  <li>
                    <span className="font-semibold text-blue-500">
                    ...
                    Admins can perform Create, Read, Update, and Delete
                    operations on user data and uploaded images.
                  </li>
                </ol>
              </div>
            </div>
      ...
      <section ref={ref5}>
        ...
        >
          <img src={AdminPanel2} className="object-cover" />
        </div>
      </section>
      <section ref={ref2}>
        <div
        ...
        >
          ...
          >
            <img src={AdminPanel3} className="object-cover " />
          </div>
          <div
            style={{
              transform: isInView2 ? "none" : "scale(0)",
            ...
            className="md:col-span-6 col-span-full rounded-3xl w-full overflow-hidden shadow-sm"
          >
            <img src={AdminPanel4} className="object-cover" />
          </div>
          <div
            style={{
              transform: isInView2 ? "none" : "scale(0)",
            ...
            className="md:col-span-6 col-span-full rounded-3xl w-full overflow-hidden shadow-sm"
          >
            <img src={AdminPanel5} className="object-cover" />
          </div>
        </div>
      </section>
      <section ref={ref3}>
            ...
            <div className="flex flex-col items-start gap-5">
              ...
              <div className="flex flex-col gap-1 text-justify">
                ...
                <p className="text-gray-400">
                  Admins must log in with their credentials to access the admin
                  panel. Once logged in, they can manage orders, customers,
                  income, feedback, and user interactions.
                </p>
                <h1 className="text-blue-500 font-semibold">
                  User Panel Control :
                </h1>
                <p className="text-gray-400">
                  Admins can control the user panel, managing the content users
                  see and interact with, ensuring a seamless user experience.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="w-full py-10" ref={ref4}>
        ...
        >
          <button className="text-4xl bg-white shadow-sm px-10 py-8 rounded-3xl text-blue-500 hover:text-black">
            <Link to={"https://github.com/akashpawar2001?tab=repositories"}>
              Next Project
            </Link>
          </button>
        </div>
