...
import ResumeWizMain from "../../assets/ResumeWiz.png";
import ResumeWiz2 from "../../assets/ResumeWiz2.png";
import ResumeWiz3 from "../../assets/ResumeWiz3.png";
import ResumeWiz4 from "../../assets/ResumeWiz4.png";
import ResumeWiz5 from "../../assets/ResumeWiz5.png";
import ResumeWiz6 from "../../assets/ResumeWiz6.png";
import ResumeWiz7 from "../../assets/ResumeWiz8.png";
function ResumeWiz() {
    ...
    <>
      <section className="py-10">
        ...
        >
          <h1 className="lg:text-5xl md:text-3xl tracking-wide font-bold inline">
            ...
            />
            <span>Resume Wiz - Crafting Your Professional Story.</span>
            <img
              src="https://wpriverthemes.com/landing/gridx-html/assets/images/star-2-2.png"
        ...
        >
          <img src={ResumeWizMain} className="object-cover" />
          <div className="absolute w-full h-full bg-black/45 flex justify-center items-center -translate-x-full group-hover:translate-x-0">
            <div className="z-10 gap-12 flex w-full h-full items-center justify-center backdrop-blur-sm p-10 rounded-3xl">
              <a
                href="https://github.com/akashpawar2001/ResumeWiz"
                target="_blank"
              ...
              <a
                href="http://resumewiz.netlify.app"
                target="_blank"
              ...
              <div className="flex flex-col gap-1">
                <ol className="flex flex-col gap-2 text-gray-400">
                  ...
                  <li>
                    ...
                    Find the perfect template with search.
                  </li>
                  <li>
                    <span className="font-semibold text-blue-500">
                      4. Multi-Format Download :{" "}
                    </span>{" "}
                    Download resumes in JPG, PNG, or PDF format.
                  </li>
                  <li>
                    <span className="font-semibold text-blue-500">
                      5. Favorite Templates :{" "}
                    </span>{" "}
                    Save and like favorite templates.
                  </li>
                </ol>
              </div>
            </div>
      ...
      <section ref={ref5}>
        <div
          ...
          className="rounded-3xl w-full py-10 mt-5 shadow-sm"
        >
          <img src={ResumeWiz3} className="object-cover" />
        </div>
      </section>
      <section ref={ref2}>
        <div
        ...
        >
          ...
          >
            <img src={ResumeWiz4} className="object-contain" />
          </div>
          <div
            style={{
              transform: isInView2 ? "none" : "scale(0)",
            ...
            className="md:col-span-6 col-span-full rounded-3xl w-full overflow-hidden shadow-sm"
          >
            <img src={ResumeWiz5} className="object-contain" />
          </div>
          <div
            style={{
              transform: isInView2 ? "none" : "scale(0)",
            ...
            className="md:col-span-6 col-span-full rounded-3xl w-full overflow-hidden md:h-[300px] shadow-sm"
          >
            <img src={ResumeWiz6} className="object-contain" />
          </div>
          <div
            style={{
              transform: isInView2 ? "none" : "scale(0)",
            ...
            className="md:col-span-6 col-span-full rounded-3xl w-full overflow-hidden shadow-sm"
          >
            <img src={ResumeWiz7} className="object-contain" />
          </div>
        </div>
      </section>
      <section ref={ref3}>
            ...
            <div className="flex flex-col items-start gap-5">
              ...
              <div className="flex flex-col gap-1 text-justify">
                <p className="text-gray-400">
                  Resume Wiz helps users create professional resumes quickly.
                  After logging in, users can search and edit various templates
                  to suit their needs. The final resume can be downloaded in
                  multiple formats, and favorite templates can be saved for
                  future use. Resume Wiz makes resume creation simple and
                  efficient.
                </p>
              </div>
            </div>
      ...
      <section className="w-full py-10" ref={ref4}>
        ...
        >
          <button className="text-4xl bg-white shadow-sm px-10 py-8 rounded-3xl text-blue-500 hover:text-black">
            <Link to={"/work/project2"}>Next Project</Link>
          </button>
        </div>
      </section>
    </>
